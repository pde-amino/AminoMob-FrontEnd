...
export default class NotifService {
  ...
  popInitialNotification() {
    if (Platform.OS === "ios") {
      ...
      console.log("popInitialNotification is not available on Android");
    }
  }

  localNotif(title = "Default Title", message = "Default Message", soundName) {
    this.lastId++;
    PushNotification.localNotification({
      ...
      actions: false, // (Android only) See the doc for notification actions to know more
      ...
      timeoutAfter: false, // (optional) Specifies a duration in milliseconds after which this notification should be canceled, if it is not already canceled, default: null
      ...
      userInfo: { screen: "Home Screen" }, // (optional) default: {} (using null throws a JSON value '<null>' error)
